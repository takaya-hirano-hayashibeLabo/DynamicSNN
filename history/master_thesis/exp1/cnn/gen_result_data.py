...
def main():
    ...
    parser.add_argument("--track_batchsize",type=int, default=10,help="データをcsvで保存するバッチサイズ")
    ...
    result_path=PARENT/f"{args.saveto}/result_tau{args.tau:.3f}/timescale{args.timescale:.2f}"

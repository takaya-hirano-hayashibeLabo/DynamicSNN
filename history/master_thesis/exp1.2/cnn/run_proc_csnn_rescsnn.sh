...
for param in "${paramlist[@]}"; do
    ...
    cpulimit -f -l 200 -- python gen_result_data.py --timescale $timescale --testnums 50 --device 7 --tau $tau --track_batchsize 3 --batchsize 100  --saveto $MODELTYPE --confpath configs/$MODELTYPE.yml
done
